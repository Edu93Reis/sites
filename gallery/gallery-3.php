...
?>
	...
	<div class="gallery-modal" id="mybtn3"> </div>
		<div class="gallery" id="dlgbox3">
							...
							<div id="big-image-container" class="galleryPreviewContainer">
								<div class="big-image">
									<video width="480" controls id="video" >										
										<source src="gallery/imagens/3/novo_centro.mp4" type="video/mp4" class="previewImage">
									</video>						
								</div>									
							</div>						
				</figure>
	...
	<button onclick="dlgClose3()" class="modal-close" id="close3" for="modal"></button>
